...
public class Issue extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(lib.LibApp.class).getContext().getResourceMap(Issue.class);
...
if(a.equals(""))
        {
            JOptionPane.showMessageDialog(this, "Please enter the Id of the book you require");
        }
        else {
    try
    {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       try{
        ...
        pst=c.prepareStatement("insert into booktransaction values('"+c1+"','"+a+"','"+date+"','"+d1+"')");
        pst.executeUpdate();
