...
public class MemberUpdate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(MemberUpdate.class);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
            {
                ...
                String b1=jTextField3.getText();
                String c1=jTextField4.getText();
                String d1=jTextField5.getText();
                String e1=jTextField6.getText();
                String f1=jTextField7.getText();


        if(a1.equals("") || b1.equals("")|| c1.equals("")|| d1.equals("")|| e1.equals("")|| f1.equals(""))
        {
 ...
 else
        {
                ...
                pst=c.prepareStatement("update memberdatabase set Name=?,MemberID=? ,Class=?, Branch=?, Year=? ,dp=? where MemberID=?");
                pst.setString(1,a1);
                pst.setString(2, b1);
                pst.setString(3, c1);
                pst.setString(4,d1);
