...
public class MemberAdd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(MemberAdd.class);
    ...
    String a1=jTextField2.getText();
        ...
        try
        {
            pst = c.prepareStatement("insert into memberdatabase values('"+a1+"','"+b1+"','"+c1+"','"+d1+"','"+e1+"','"+f1+"','"+s+"')");
            pst.executeUpdate();
