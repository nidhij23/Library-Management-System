...
public class MemberListByYear extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()==b1)
        {
            String p=t1.getText();
                        if(p.equals(""))
        {
             JOptionPane.showMessageDialog(this,"Please fill in the Year");
        }
 else
                        {
    ...
    try
        {
        pst=c.prepareStatement("Select * from memberdatabase where Year=?");
        pst.setString(1,p);
        rs=pst.executeQuery();
    ...
    {
        MemberListByYear b=new MemberListByYear();
    }
}
