...
public class BookTransaction extends javax.swing.JFrame {
    ...
    jsp.setBounds(70,300,400,50);
    add(jsp);

        jLabel2=new JLabel("",img,JLabel.LEFT);
        jLabel2.setBounds(15,100,100,100);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(lib.LibApp.class).getContext().getResourceMap(BookTransaction.class);
    ...
    try
    {
        ...
        pst2=c.prepareStatement("select * from booktransaction where  MemberID=?");
        pst2.setString(1,a);
        rs2=pst2.executeQuery();
        rs2.next();
 
        jLabel14.setText(rs2.getString(2));
    }
    catch(Exception e)
    {
