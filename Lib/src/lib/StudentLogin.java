...
public class StudentLogin extends javax.swing.JFrame {
    ...
    public StudentLogin() {
        ...
        img=new ImageIcon("StudentLogin.jpg");
...
try
  ...
  catch(Exception e)
  {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(StudentLogin.class);
...

{
    ...
    setVisible(false);
    new StudentHome(jTextField2.getText()).setVisible(true);
    }
 else
