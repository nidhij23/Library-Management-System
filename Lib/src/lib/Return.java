...
public class Return extends javax.swing.JFrame {
    ...
    public Return() {
        ...
        cc=new JLabel("",img,JLabel.CENTER);
        cc.setBounds(30,90,100,100);
        add(cc);
        cc.setVisible(false);
        try
        {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(lib.LibApp.class).getContext().getResourceMap(Return.class);
...
if(a.equals(""))
    ...
    try
    {
        ...
        pst2=c.prepareStatement("select * from booktransaction where bookID=?");
        pst2.setString(1,a);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            ...
            String a=jTextField1.getText();
            String b=jLabel16.getText();
            Date date=new Date();
        try
        {
        pst=c.prepareStatement("delete from booktransaction where DateOfIssue=p");
        pst.executeUpdate();
        }
        catch(Exception e)
        {
        ...
        try
        {
            pst=c.prepareStatement("insert into booktransaction values('"+b+"','"+a+"','"+p+"','"+date+"')");
            pst.setString(1,p);
