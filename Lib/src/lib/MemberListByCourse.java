...
public class MemberListByCourse extends JFrame implements ActionListener{
    ...
    setSize(600,500);
    setLocation(300,200);
    setTitle("Member list by Course");
    ...
    try
        {
        pst=c.prepareStatement("Select * from memberdatabase where Class=?");
        pst.setString(1,p);
        rs=pst.executeQuery();
    ...
    {
        MemberListByCourse b=new MemberListByCourse();
    }
}
