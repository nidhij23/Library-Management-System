...
public BookRemove(){
    ...
    setLocation(400,200);
    jLabel1=new JLabel("",img,JLabel.CENTER);
        jLabel1.setBounds(15,130,100,100);
        add(jLabel1);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(lib.LibApp.class).getContext().getResourceMap(BookRemove.class);
 ...
 else
{
        try
        {
            pst = c.prepareStatement("delete from bookdatabase where bookID=?");
    pst.setString(1,a);
    pst.executeUpdate();
