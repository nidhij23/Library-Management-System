...
public class BookListByPublisher extends JFrame implements ActionListener{
    ...
    l1=new JLabel("Enter Publisher Name :");
    l1.setBounds(10,10,150,20);
    add(l1);
    t1=new JTextField();
    t1.setBounds(160,10,200,20);
    add(t1);
    b1=new JButton("View");
    ...
    setSize(600,500);
    setLocation(200,200);
    setTitle("Book List by Publisher");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()==b1)
        {
            String p=t1.getText();
              if(p.equals(""))
        {
             JOptionPane.showMessageDialog(this,"Please fill in the Book Publisher");
        }
 else
              {
    ...
    try
        {
        pst=c.prepareStatement("Select * from bookdatabase where Publisher=?");
        pst.setString(1,p);
        rs=pst.executeQuery();
        int r=0;
    while(rs.next())
    ...
    {
        BookListByPublisher b=new BookListByPublisher();
    }
}
