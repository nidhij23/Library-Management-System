...
public class MemberListByBranch extends JFrame implements ActionListener{
    ...
    setSize(600,500);
    setLocation(300,200);
    setTitle("Member list by Branch");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()==b1)
        {
            String p=t1.getText();
                           if(p.equals(""))
        {
             JOptionPane.showMessageDialog(this,"Please fill in the Branch");
        }
 else{
    ...
    try
        {
        pst=c.prepareStatement("Select * from memberdatabase where Branch=?");
        pst.setString(1,p);
        rs=pst.executeQuery();
    ...
    {
        MemberListByBranch b=new MemberListByBranch();
    }
}
