...
public class IssueBook extends javax.swing.JFrame {
    ...
    public IssueBook(String m1,String countm) {
        initComponents();
        String s=m1;
        String cm=countm;
        try
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(IssueBook.class);
    ...
    try
    {
        pst=c.prepareStatement("select * from bookdatabase where bookID=?");
        pst.setString(1,a);
        rs=pst.executeQuery();
        rs.next();
        ...
        jLabel14.setText(rs.getString(8)+" books Available");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String a=jTextField1.getText();
              if(a.equals(""))
        {
             JOptionPane.showMessageDialog(this,"No Book ID entered");
        }
 else
              {
        int cm1=Integer.parseInt(jLabel16.getText());
        int cb1=Integer.parseInt(jLabel17.getText());
        System.out.println(cb1+" "+cm1);
        cb1--;
        cm1++;
        ...
        System.out.println(cb2+" "+cm2);
        Date date=new Date();
        
       try{

        pst=c.prepareStatement("insert into booktransaction values('"+c1+"','"+p+"','"+date+"','"+d1+"','"+cm2+"')");
        pst.executeUpdate();
        pst.close();
