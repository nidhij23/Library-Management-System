...
try
  ...
  catch(Exception e)
  {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(AdminLogin.class);
...
try
{
pst=c.prepareStatement("select * from userlogin where UserID=?");
pst.setString(1,x);
rs=pst.executeQuery();
rs.next();
...
{
    JOptionPane.showMessageDialog(this,"Please fill in the username & password");
}
